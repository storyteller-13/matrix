...
window.QUOTES = [
    ...
    { text: 'i am no longer a child, and i am not yet an adult.', author: 'jean-paul sartre' },

    // aristotle
	{ text: 'we are what we repeatedly do. excellence, then, is not an act, but a habit.', author: 'aristotle' },
    { text: 'then, as in the case of an archer, there must be some end at which we aim, and we shall be more likely to hit the mark if we have a target.', author: 'aristotle' },
	...
	{ text: 'it is the nature of desire not to be satisfied.', author: 'aristotle' },
	...
	{ text: 'nature does nothing in vain.', author: 'aristotle' },
	...
	{ text: 'flourishing (eudaimonia) is the highest good.', author: 'aristotle' },
	{ text: 'the good for man is an activity of the soul in accordance with virtue.', author: 'aristotle' },
	{ text: 'the happy life is thought to be virtuous; now a virtuous life requires exertion.', author: 'aristotle' },
	{ text: 'the life of contemplation is best and happiest.', author: 'aristotle' },
	{ text: 'we become just by doing just acts, temperate by doing temperate acts, brave by doing brave acts.', author: 'aristotle' },
	...
	{ text: 'the virtue of justice is thought to be the sum of all virtues.', author: 'aristotle' },
	{ text: 'knowing yourself is the beginning of all wisdom.', author: 'aristotle' },
	{ text: 'he who has overcome his fears will truly be free.', author: 'aristotle' },
	{ text: 'quality is not an act, it is a habit.', author: 'aristotle' },
	{ text: 'virtue is the golden mean between two vices, the one of excess and the other of deficiency.', author: 'aristotle' },
	{ text: 'educating the mind without educating the heart is no education at all.', author: 'aristotle' },
	{ text: 'to function well is the characteristic end of every thing, as sight is of the eye.', author: 'aristotle' },
    ...
    { text: 'one must never attempt to fake reality in any manner.', author: 'ayn rand' },
    { text: 'honesty is the recognition of the fact that the unreal is unreal and can have no value.', author: 'ayn rand' },
    { text: 'honesty is not a social duty, not a sacrifice for the sake of others, but the most profoundly selfish virtue man can practice.', author: 'ayn rand' },
    { text: 'the honest person does not pretend that things are other than they are, either to others or to himself.', author: 'ayn rand' },
    { text: 'honesty is the recognition of the fact that you cannot fake existence.', author: 'ayn rand' },
    { text: 'intellectual honesty consists in taking ideas seriously.', author: 'ayn rand' },
    { text: 'knowing what one does know, constantly expanding one’s knowledge, and never evading or failing to correct a contradiction.', author: 'ayn rand' },
    { text: 'the mark of an honest man is that he means what he says and knows what he means.', author: 'ayn rand' },
    { text: 'achievement of your happiness is the only moral purpose of your life, and that happiness — not pain or mindless self-indulgence — is the proof and the result of your loyalty to your values.', author: 'ayn rand' },
    { text: 'a rational man never distorts or falsifies the facts of reality.', author: 'ayn rand' },
    { text: 'my philosophy, in essence, is the concept of man as a heroic being, with his own happiness as the moral purpose of his life, with productive achievement as his noblest activity, and reason as his only absolute.', author: 'ayn rand' },
    { text: 'the purpose of morality is to teach you, not to suffer and die, but to enjoy yourself and live.', author: 'ayn rand' },
    ...
    { text: 'a man’s sexual choice is the result and sum of his fundamental convictions.', author: 'ayn rand' },
    { text: 'the man who does not know what he wants to be cannot know what he wants.', author: 'ayn rand' },
    { text: 'the man who lets a leader prescribe his course is a wreck being towed to the scrap heap.', author: 'ayn rand' },
    { text: 'the question is not who is going to let me; the question is who is going to stop me.', author: 'ayn rand' },
    { text: 'force and mind are opposites; morality ends where a gun begins.', author: 'ayn rand' },
    { text: 'the truth is not for all men, but only for those who seek it.', author: 'ayn rand' },
    { text: 'do not let your fire go out, spark by irreplaceable spark, in the hopeless swamps of the not - quite, the not - yet, and the not-at-all.', author: 'ayn rand' },
    { text: 'run for your life from any man who tells you that money is evil.', author: 'ayn rand' },
    { text: 'wealth is the product of man’s capacity to think.', author: 'ayn rand' },
    { text: 'every man builds his world in his own image. he has the power to choose, but no power to escape the necessity of choice.', author: 'ayn rand' },
    { text: 'the man who does not value himself, cannot value anything or anyone.', author: 'ayn rand' },
    { text: 'the hardest thing to explain is the glaringly evident which everybody had decided not to see.', author: 'ayn rand' },
    ...
    { text: 'but if the optimal route looks too quiet, the solution is not to avoid it. the solution is to stand firm, knowing that you’re doing the right thing, and eventually the results will speak for themselves.', author: 'paul graham' },
    ...
    { text: 'when i think about my slavery and ask, why me?, i try to step outside myself and imagine how others felt following my story. i realize they might have felt exactly the same excruciating pain and revulsion — and we are all healing together.', author: 'marina von steinkirch' },
    { text: 'learn to harness your primary font of energy from love — the real carnot inline machine. everything will be colorful, musical, tasteful, and magical, every single instant, infinitely.', author: 'marina von steinkirch' },
    { text: 'integrity and maturity mean you don’t humiliate others to feel superior, and you recognize your mistakes and take responsibility for fixing them. simple like the sun shining every morning.', author: 'marina von steinkirch' },
    { text: 'we don’t create rules and laws to avoid pain and suffering; we create rules and laws to become our best selves after experiencing pain and suffering.', author: 'marina von steinkirch' },
    { text: 'if you want to be a successful builder, i have two pieces of advice: work as hard as you can to master your craft, and stay absolutely away from drama.', author: 'marina von steinkirch' },
    { text: 'after years of completely disintegrating the self, i finally realize that every single soul around me is a beautiful, but scary, child.', author: 'marina von steinkirch' },
    { text: 'does evil exist because of free will, or does free will exist because of evil? — assumming they are both real, of course.', author: 'marina von steinkirch' },
    { text: 'the hardest downside of reading minds is learning about an unexpected betrayal. that’s probably why you gotta have a very strong, ego-dead self to deal with this brave new world skill.', author: 'marina von steinkirch' },
    { text: 'if i have to make the choice, i will choose a thousand times over to be the one who gives rather than the one who takes.', author: 'marina von steinkirch' },
    { text: 'never underestimate the damage that envy and ignorance can inflict on an unguarded life. guard your diamonds by keeping distance from those who let both guide their lives.', author: 'marina von steinkirch' },
    { text: 'you know you have reached a certain completeness as a human when you realize there will be only one person beside you until your last day — even if you have not met that person yet.', author: 'marina von steinkirch' },
    { text: 'there is nothing more sublime and gratifying than having the privilege of devoting yourself to your craft every day with a childlike sense of wonder.', author: 'marina von steinkirch' },
    { text: 'rose-colored pareto rule: if 80% of your life was free, healthy, and loved, you’re very lucky — and whatever you’re going through now, you’ll overcome. if not, the odds are on your side, and you’ll have an amazing future ahead if you set your mind right.', author: 'marina von steinkirch' },
    { text: 'when you trap a very creative and intelligent person inside a box, their mind takes the shape of an octopus.', author: 'marina von steinkirch' },
    { text: 'energy matches energy — after all the trials, all the choices, and all the searching, the people you end up with are an inexorable reflection of who you trully are.', author: 'marina von steinkirch' },
    { text: 'the people who sacrifice integrity, growth, and honesty for attention should be the first to leave your life. the longer they remain in your field, the more damage they will cause — and they feed on it.', author: 'marina von steinkirch' },
    { text: 'every day better; every day smarter; every day stronger; every day closer.', author: 'marina von steinkirch' },
    { text: 'you must learn how to control your mind. if you wake from a bad dream, you need to take control of your thoughts and teach your brain to release the neurosis by replacing it with something you can feel grateful for that is related to it.', author: 'marina von steinkirch' },
    { text: 'the only reason i am still alive and pushing myself every day to become better is because of — and for — the good people in my life.', author: 'marina von steinkirch' },
    ...
    { text: 'mortality is the ultimate and greatest source of redemption.', author: 'marina von steinkirch' },
    { text: 'the most beautiful thing about good is that it\'s a permanent force; the most reassuring thing about evil is that it\'s always revealed and defeated, even if it takes time.', author: 'marina von steinkirch' },
    { text: 'never understimate the power of a healthy boundary against envy.', author: 'marina von steinkirch' },
    { text: 'privacy is the single most important aspect of being human; no one should have the right to invade your thoughts or steal your agency.', author: 'marina von steinkirch' },
    { text: 'forgive, even if your enemy hasn’t learned to do so yet. let him take his time while you stay away and live your best life.', author: 'marina von steinkirch' },
    { text: 'remember that you are an unlimited source of love and light; this is your source of flourishing and the one power that evil can never take from you.', author: 'marina von steinkirch' },
    { text: 'anytime you partake in bullying, you are holding hands with evil.', author: 'marina von steinkirch' },
    { text: 'better to be the oppressed than the oppressor; better to be on the right side of the scales than to be the one bringing hell to earth.', author: 'marina von steinkirch' },
    { text: 'in a world where ignorance reigns, it’s much harder to be on the side of those who are trying to tip the scales toward good.', author: 'marina von steinkirch' },
    { text: 'i will never forget the day when my mind was free; the day when all i felt for my oppressor was pity; the day i learned that their tactics had zero effect on me. that day, i knew i was no longer their victim.', author: 'marina von steinkirch' },
    { text: 'every human being has the right to redemption; every human being has the right to move forward with their lives and flourish. anyone who denies these rights is part of the forces of evil.', author: 'marina von steinkirch' },
    { text: 'be sorry for anyone who attacks you from a position of power; they don’t know any better. this is the most obvious sign of inner weakness.', author: 'marina von steinkirch' },
    { text: 'when i was imprisoned and realized i was not going to be set free, i made use of the only power nobody could ever take from me: my will. i chose to move on with my life and live according to what remained of my agency.', author: 'marina von steinkirch' },
    { text: 'you might have taken my dignity. you might have taken my voice, my wealth, my past, my privacy. but you will never take my mind, my dreams, or my hope.', author: 'marina von steinkirch' },
    { text: 'today is a great day to believe in your dreams.', author: 'marina von steinkirch' },
    { text: 'you have the advantage of time and energy over anyone older than you who is oppressing or bullying you. focus on your goals, keep progressing, you will prove your worth — and, in the end, you will have the last laugh.', author: 'marina von steinkirch' },
    { text: 'there is something very powerful, soft, and safe about a mature love — one that is not built on dopamine, risk, or drama.', author: 'marina von steinkirch' },
    { text: 'it\'s your job to live your life. it\'s your job to let others live their lives without your judgment. and it\'s your job to own the choices you make in the game of choices — and do it as gracefully and gratefully as you can.', author: 'marina von steinkirch' },
    { text: 'the better, kinder, fairer you become — the closer you get to becoming the ideal human by every measure — the more there will be forces trying to steal your light. every day, repeat: "i’m unkillable; i’m not going anywhere but to the top."', author: 'marina von steinkirch' },
    { text: 'on those tough nights, congratulate yourself for simply being alive, and trust that tomorrow, the sun will rise again.', author: 'marina von steinkirch' },
    { text: 'how weird it would be if there were a very interesting woman who was unknowingly being watched, and as she lived her life, trying to seek help for the strange consequences of such an abnormal situation, her watchers continuously thought she was communicating with them.', author: 'marina von steinkirch' },
    { text: 'an honorable man, when his romantic advances are rejected, should still wish the woman he loved happiness. that is the honorable way to live. he should never try to win her by force, demean her, or make her feel inferior or insane. that would rather be called cruelty.', author: 'marina von steinkirch' },
    { text: 'there will always be people trying to grift your life — forget their existence, protect your peace, and keep working, focusing, dreaming, and shining.', author: 'marina von steinkirch' },
    { text: 'if you’re lucky enough in life, there will come a moment when you finally understand what romantic love truly feels like.', author: 'marina von steinkirch' },
    { text: 'my past is my strength, and my future is mine — mine alone.', author: 'marina von steinkirch' },
    { text: 'when you find yourself under an unknown attack, slightly remove yourself from the situation and observe who celebrates it. then return to your place stronger, smarter, and unbothered by the noise.', author: 'marina von steinkirch' },
    { text: 'my life became so much more interesting when i started looking at npcs as either little cute angels or little cute demons.', author: 'marina von steinkirch' },
