...
const I18N_STRINGS = {
    en: {
        ...
        'menu.applications': 'operating system',
        'menu.whoIAm': 'who i am',
        'menu.whatIDo': 'what i do',
        'menu.terminal': 'terminal',
        'menu.artwork': 'artwork',
        'menu.reflections': 'reflections',
        'menu.focusList': 'focus list',
        'menu.calendar': 'calendar',
        'menu.dailySublime': 'the daily sublime',
        'menu.curateLists': 'my curated lists',
        'menu.buildingMyLife': 'building my life',
        'menu.listsBooks': 'books',
        'menu.listsMovies': 'movies',
        'menu.listsGames': 'games',
        'menu.listsPlaces': 'places',
        'menu.listsPodcasts': 'podcasts',
        'menu.listsArt': 'art',
        'menu.listsArticles': 'articles',
        'menu.listsFood': 'food',
        'menu.listsMusic': 'music',
        'menu.books2026': 'books i am reading in 2026',
        'menu.allOldStories': 'all the old stories',
        ...
        'window.books': 'books i am reading in 2026',
        'window.about': 'WHO I AM',
        'window.home': 'WHAT I DO',
        'window.artwork': 'ARTWORK',
        'lists.reading': 'books read this month',
        'lists.rating': 'rating',
        'lists.notes': 'notes',
...
(for now, enjoy my carefully curated little mixtapes)`,
    ...
    ja: {
        ...
        'menu.applications': 'オペレーティングシステム',
        'menu.whoIAm': 'わたし',
        'menu.whatIDo': 'おしごと',
        'menu.terminal': 'ターミナル',
        'menu.artwork': 'アート',
        'menu.reflections': 'かんそう',
        'menu.focusList': 'フォーカス',
        'menu.calendar': 'カレンダー',
        'menu.dailySublime': 'デイリーサブライム',
        'menu.curateLists': 'マイキュレートリスト',
        'menu.buildingMyLife': 'じんせいをつくる',
        'menu.listsBooks': 'ほん',
        'menu.listsMovies': 'えいが',
        'menu.listsGames': 'あそび',
        'menu.listsPlaces': 'ばしょ',
        'menu.listsPodcasts': 'ポッドキャスト',
        'menu.listsArt': 'アート',
        'menu.listsArticles': 'きじ',
        'menu.listsFood': 'たべもの',
        'menu.listsMusic': 'おんがく',
        'menu.books2026': '2026ねんによんでいるほん',
        ...
        'calendar.noEvents': 'こんげつのよていはないよ',
        'calendar.prev': 'まえのつき',
        'calendar.next': 'つぎのつき',
        ...
        'calendar.month.1': '1がつ',
        'calendar.month.2': '2がつ',
        'calendar.month.3': '3がつ',
        'calendar.month.4': '4がつ',
        'calendar.month.5': '5がつ',
        'calendar.month.6': '6がつ',
        'calendar.month.7': '7がつ',
        'calendar.month.8': '8がつ',
        'calendar.month.9': '9がつ',
        'calendar.month.10': '10がつ',
        'calendar.month.11': '11がつ',
        'calendar.month.12': '12がつ',
        'window.todo': 'フォーカスリスト',
        'window.notes': 'ものがたり、アート、てつがく',
        'window.books': '2026ねんによんでいるほん',
        'window.about': 'わたし',
        'window.home': 'おしごと',
        'window.artwork': 'アート',
        'lists.reading': 'こんげつよんだほん',
        'lists.rating': 'ひょうか',
        'lists.notes': 'メモ',
        'lists.thoughts': 'かんそう',
        'lists.backlog': 'マイバックログ',
        'lists.folderEmpty': 'このフォルダはからっぽ',
        'lists.back': 'もどる',
